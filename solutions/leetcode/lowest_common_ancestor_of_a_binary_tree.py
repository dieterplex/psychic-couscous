...
class Solution:
    def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
        """
        >>>  Solution().lowestCommonAncestor(root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 1)
        3
        >>>  Solution().lowestCommonAncestor(root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 4)
        5
        >>>  Solution().lowestCommonAncestor(root = [1,2], p = 1, q = 2)
        1
        """
        return 0
